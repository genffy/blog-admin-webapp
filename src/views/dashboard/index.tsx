...
class DashBoard extends React.Component<any, any> {
    ...
    componentWillMount() {
        // this.props.selectLastAsync();
        // this.props.systemInfoAsync();
    }
    updateSystem (){
        updateSystemAsync(this.state.step);
    }
                ...
                <div className="manage-container">
                    {versions.needUpdate ?
                        <p className="bg-info update-message">
                            ...
                            >下载更新</a> 或者使用 <a href="javascript:;" onClick={() => this.renderUpdateConfirm()}
                            >在线更新</a>！
                        </p>
                        : null}
...
const mapStateToProps = (state: DashBoardState) => ({
    count: state.systemInfo.count,
    posts: state.posts,
    versions: state.systemInfo.versions,
    step: state.step,
  });
  
  const mapDispatchToProps = { selectLastAsync, systemInfoAsync };
